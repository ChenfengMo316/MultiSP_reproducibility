...
setwd("./data/MISAR_seq/")


#RNA
adata <- read_h5ad("MISAR_E15_5_S1_adata_RNA.h5ad")
...
#ATAC
adata_atac <- read_h5ad("MISAR_E15_5_S1_adata_ATAC.h5ad")
...
combined <-find_optimal_clusters(combined,target_clusters=12)
