...
setwd("./data/spatial DBIT-seq mouse embryo/")

adata <- read_h5ad("D:/Spatial omic/data/spatial DBIT_seq mouse embyro 0713/mouse_embro_0713_rna.h5ad")
rna <- CreateSeuratObject(counts = t(adata$X), meta.data = adata$obs)
print(rna)


adata_adt <- read_h5ad("D:/Spatial omic/data/spatial DBIT_seq mouse embyro 0713/mouse_embro_0713_protein.h5ad")
...
combined <-find_optimal_clusters(combined,target_clusters=10)
