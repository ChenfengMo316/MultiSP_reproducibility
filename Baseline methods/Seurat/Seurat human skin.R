...
setwd("./data/spatial CITE_seq human skin/")

adata <- read_h5ad("D:/Spatial omic/Seurat/data/human_skin rna.h5ad")
rna <- CreateSeuratObject(counts = t(adata$X), meta.data = adata$obs)
print(rna)


adata_adt <- read_h5ad("D:/Spatial omic/Seurat/data/human_skin adt.h5ad")
