...
setwd("./data/spatial ATAC-RNA-seq E13 mouse embryo/")


#RNA
adata <- read_h5ad("D:/Spatial omic/Seurat/data/mouse_embryo rna.h5ad")
...
#ATAC
adata_atac <- read_h5ad("D:/Spatial omic/Seurat/data/mouse_embryo atac.h5ad")
